        ...
        <div className="space-y-8 text-center">
          ...
          <div className="space-y-1">
            <div className="h-px w-12 mx-auto"
              style={{ background: "linear-gradient(90deg, transparent, rgba(var(--accent-bright-rgb),0.5), transparent)" }} />
          ...
          <Link href="/about/manifesto"
            ...
            style={{
              ...
              boxShadow: "0 0 0 1px rgba(var(--accent-bright-rgb),0.4), 0 8px 24px rgba(var(--accent-rgb),0.3)",
            }}>
