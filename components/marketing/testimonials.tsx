      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-center">
          ...
          <div className="space-y-1">
            <div className="h-px w-12 mx-auto" style={{ background: "linear-gradient(90deg, transparent, rgba(139,92,246,0.5), transparent)" }} />
            <p className="text-[--text-muted] text-xs pt-2 uppercase tracking-widest font-medium">Thesis IX · The Dauntless Manifesto</p>
          </div>
